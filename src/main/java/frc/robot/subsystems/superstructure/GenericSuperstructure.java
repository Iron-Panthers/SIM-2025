...
public abstract class GenericSuperstructure<G extends GenericSuperstructure.PositionTarget> {
    ...
    private GenericSuperstructureIOInputsAutoLogged inputs = new GenericSuperstructureIOInputsAutoLogged();
    ...
    public boolean reachedTarget() {
        return Math.abs(inputs.positionRotations - (positionTarget.getPosition())) <= positionTarget.getEpsilon();
    }
}
