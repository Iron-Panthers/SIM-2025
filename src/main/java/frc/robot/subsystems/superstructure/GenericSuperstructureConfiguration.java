...
public class GenericSuperstructureConfiguration {
  ...
  /**
   * Non-zero ID of secondary mechanism motor, if applicable.
   *
   * <ul>
   *   <li><b>Default Value:</b> 0
   * </ul>
   ...
   * </ul>
   */
  public GenericSuperstructureConfiguration withSecondaryMotorID(int id2) {
    this.id2 = id2;
    return this;
  }
  ...
  /**
   * If secondary motor goes in the opposite direction of the main
   *
   * <ul>
   *   <li><b>Default Value:</b> false
   * </ul>
   */
  public boolean oposeFirst = false;
   ...
   * @return itself
   */
  public GenericSuperstructureConfiguration withSecondaryMotorDirection(boolean oposeFirst) {
    this.oposeFirst = oposeFirst;
    return this;
  }
