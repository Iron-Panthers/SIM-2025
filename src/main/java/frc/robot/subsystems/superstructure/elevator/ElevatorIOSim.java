...
public class ElevatorIOSim implements ElevatorIO {
    ...
    public ElevatorIOSim() {
        ...
        int id = ElevatorConstants.ELEVATOR_CONFIG.motorID();
    ...
    public void updateInputs(ElevatorIOInputs inputs) {
        ...
        double rotations = elevatorSim.getPositionMeters() / (2 * Math.PI * drumRadiusMeters) * reduction;
        double velocityRPS = elevatorSim.getVelocityMetersPerSecond() / (2 * Math.PI * drumRadiusMeters) * reduction;
    ...
    public void runPosition(double rotations) {
        System.out.println("Running elevator to position: " + rotations + " rotations");
