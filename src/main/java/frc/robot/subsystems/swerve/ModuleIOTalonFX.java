...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    private final MotionMagicVoltage steerPositionControl = new MotionMagicVoltage(0).withUpdateFreqHz(0);
    ...
    public ModuleIOTalonFX(ModuleConfig config) {
        ...
        steerAbsolutePosition = () -> Rotation2d.fromRotations(encoder.getAbsolutePosition().getValueAsDouble());
