...
public class GenericSuperstructureConfiguration {
  ...
  public double supplyCurrentLimit = 70;
    ...
    /**
     * The non-zero ID for a CANCoder. The Talon will update its position and
     * velocity whenever
     * CANcoder publishes its information on CAN bus, and the Talon internal rotor
     * will not be used.
     */
    ...
    /**
     * This offset is added to the reported CANCoder position if CANCoder ID is not
     * 0.
     *
     * <ul>
    ...
    /**
     * Direction of the CANCoder to determine positive rotation, as seen facing the
     * LED side of the
     * CANcoder.
     *
     * <ul>
     ...
     *
     * <p>
     * This is equivalent to the mechanism's gear ratio if the sensor is located on
     * the input of a
     * gearbox. If sensor is on the output of a gearbox, then this is typically set
     * to 1.
     *
     * <p>
     * Don't use this config to perform unit conversion.
     *
     * <p>
     * *
     *
    ...
    /**
     * Voltage threshold to determine if the mechanism has reached the zeroing
     * position.
     *
     * <ul>
     * <li><b>Default Value:</b> 0
