...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // .repeatedly()); // so if it aligns to L4 prep, it will then try to align to
        // L4
        // // auto align
        // driverA
        // .rightBumper()
        ...
        // .alongWith(
        // new InstantCommand(
        // () -> levelOffsets = levelOffsets == LevelOffsets.L4_OFFSET
        ...
        // .x()
        // .onTrue(
        // new InstantCommand(() -> swerve.setTargetHeading(new
        // Rotation2d(Math.toRadians(128)))));
        //
        // driverA
        // .b()
        // .onTrue(
        // new InstantCommand(() -> swerve.setTargetHeading(new
        // Rotation2d(Math.toRadians(232)))));
        //
        // // -----Superstructure Controls-----
        // // auto go to L1
        // new Trigger(
        // () -> 2.5 > RobotState.getInstance()
        // .getEstimatedPose()
        // .getTranslation()
        // .minus(DriveConstants.REEF_TRANSLATION2D)
        // .getNorm()
        ...
        //
        // new Trigger(() -> driverB.a().getAsBoolean() &&
        ...
        // );
        //
        // new Trigger(() -> driverB.b().getAsBoolean() &&
        // driverB.start().getAsBoolean())
        // .onTrue(
        // climbController
        ...
        // new Trigger(() -> (superstructure.getCurrentState() ==
    ...
    public static Rotation2d calculateSnapTargetHeading(Rotation2d targetHeading) {
        targetHeading = targetHeading.rotateBy(
        ...
        for (double snap : DriveConstants.REEF_SNAP_ANGLES) {
            if (Math.abs(relativeAngularDifference(targetHeading.getDegrees(), snap)) < Math
                    .abs(relativeAngularDifference(targetHeading.getDegrees(), closest))) {
                closest = snap;
            }
        }
